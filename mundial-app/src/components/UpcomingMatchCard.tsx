...
export default function UpcomingMatchCard({ match }: Props) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-5 flex flex-col items-center gap-3 text-gray-900">
      <div className="flex w-full items-center justify-center gap-4">
        <span className="flex-1 text-right font-semibold truncate">{match.local}</span>
        <span className="text-xs font-bold uppercase text-indigo-500">vs</span>
